        ...
        <div className="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
            ...
            <div className="navbar-collapse collapse w-100 order-3 dual-collapse2">
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item">
                    <Link type="button" className="btn btn-light" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><i className="fa fa-user-secret text-primary"></i> Hello Admin, <b className="text-dark text-capitalize">{user}</b></Link>
                    </li>
