...
<br></br>
Any process regarding the use of mediation and any mediation session is done under the seal of confidentiality and subject to all rights and remedies of the parties. Nothing said or written during such a proceeding or session, however, is admissible in evidence in any legal or other proceeding.
<br></br>
Any dispute or dispute that cannot be resolved in mediation, within ninety (90) days of the appointment of the mediator, must be submitted to arbitration according to the procedure provided for in this contract.
                </p>
                <h5>ARBITRATION</h5>
                <p className="text mb-5 text-secondary">
...
<br></br>
The costs of the arbitration will be shared between the parties unless otherwise agreed upon by the parties.
<br></br>
...
export default ClausesMediationArbitration
