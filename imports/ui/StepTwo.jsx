...
const StepTwo = ({ setData, setStep, data,datta}) => {
  ...
  const { register, handleSubmit, errors } = useForm({
    ...
    defaultValues: {
      vousB: data.vousB || datta.vousB,
      nomsoc1: data.nomsoc1 || datta.nomsoc1,
      formjurid1: data.formjurid1 || datta.formjurid1,
      numid1: data.numid1 || datta.numid1,
      prerepleg1: data.prerepleg1 || datta.prerepleg1,
      nomrepleg1: data.nomrepleg1 || datta.nomrepleg1,
      adresse1: data.adresse1 || datta.adresse1,
      codepos1: data.codepos1 || datta.codepos1,
      ville1: data.ville1 || datta.ville1,
      email1: data.email1 || datta.email1,
      tel1: data.tel1 || datta.tel1,
      namelawyer1: data.namelawyer1 || " ",
      firstnamelawyer1: data.firstnamelawyer1 || " ",
      adresslawyer1: data.adresslawyer1 || " ",
      emaillawyer1: data.emaillawyer1 || "vide@example.com",
