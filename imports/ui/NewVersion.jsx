    ...
    return (
        <div>
            ...
            <div className="card border-0 ">
                    ...
                    <i className="fa fa-clone text-primary fa-3x" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-users text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-credit-card text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-table text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-pencil-square-o text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-television text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-clipboard text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-floppy-o text-primary fa-3x mt-3" aria-hidden="true"></i>
                ...
                <div className="card border-0 ">
                    <div className="card body">
                    <i className="fa fa-comments-o text-primary fa-3x mt-3" aria-hidden="true"></i>
