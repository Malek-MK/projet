...
<div className="row">
    ...
    <div className="card border-0 mt-5 text-center">
      <div className="card-body">
      <i className="fa fa-pencil-square-o text-primary fa-5x mt-3 mb-3" aria-hidden="true"></i>
  ...
  <div className="col-sm-6 mt-3">
    <div className="card border-0 mt-5 text-center">
      <div className="card-body">
      <i className="fa fa-television text-primary fa-5x mt-3 mb-3" aria-hidden="true"></i>
  ...
  <div className="col-sm-6 mt-4">
    <div className="card border-0  text-center">
      <div className="card-body">
      <i className="fa fa-pencil-square text-primary fa-5x mt-3 mb-2" aria-hidden="true"></i>
  ...
  <div className="col-sm-6 mt-3">
    <div className="card border-0  text-center">
      <div className="card-body">
      <i className="fa fa-clipboard text-primary fa-5x mt-4 mb-2" aria-hidden="true"></i>
  ...
  <div className="col-sm-6 mt-3">
    <div className="card border-0 text-center">
      <div className="card-body">
      <i className="fa fa-floppy-o text-primary fa-5x mt-3" aria-hidden="true"></i>
  ...
  <div className="col-sm-6 mt-3">
    <div className="card border-0 mt-3 text-center">
      <div className="card-body">
      <i className="fa fa-comments-o text-primary fa-5x mt-1 " aria-hidden="true"></i>
