  ...
  <div className="col-sm-6 mt-5">
    <div className="card border-0">
      <div className="card-body">
        <h2>Companies</h2>
        <h4 className="card-text text-secondary mt-3">Vous rencontrez un problème avec un fournisseur, un client, un partenaire d’affaires, ou même un salarié et vous envisagez d’engager une procédure auprès d’un tribunal. Cependant, vous vous rendez compte que les délais sont très longs et que le budget estimé est beaucoup trop important.
...
SpeedSolution est la solution qu’il vous faut, tous nos prix sont clairs et prévisibles et nous pouvons vous offrir une date de médiation en un délai record.</h4>
  ...
  <div className="col-sm-6 mt-1 mb-5">
    <div className="card border-0">
      <div className="card-body">
  ...
  <div className="col-sm-6 mt-5">
    <div className="card border-0">
      ...
      <br></br><br></br>
        <h2>Individuals</h2>
        <h4 className="card-text text-secondary mt-3">Are you an individual facing a dispute?

Want to avoid wasting time and money going through the courts? You are in the right place.

Thanks to Communty, find an agreement and settle your dispute amicably in just a few days while being accompanied by an accredited mediator.</h4>
      </div>
    </div>
  </div>
  <div className="col-sm-6 mt-5">
...
The SpeedSolution platform allows you to manage all these disputes simply and economically thanks to adapted pricing formulas. By reserving a certain number of hours in advance, you gain access to much cheaper rates.</h4>
  ...
  <div className="col-sm-6 mt-1">
    <div className="card border-0">
      <div className="card-body">
      <img src="./images/img6.png" alt="Logo" /> 
      </div>
    </div>
  </div>
</div>
