...
const Features = () => {
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body border-0">
      <i className="fa fa-file-text-o fa-5x text-primary" aria-hidden="true"></i>
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body border-0">
      <i className="fa fa-pie-chart fa-5x text-primary" aria-hidden="true"></i>
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body border-0">
      <i className="fa fa-calendar fa-5x text-primary" aria-hidden="true"></i>
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body">
      <i className="fa fa-pencil-square-o fa-5x text-primary" aria-hidden="true"></i>
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body">
      <i className="fa fa-male fa-5x text-primary" aria-hidden="true"></i>
  ...
  <div className="col-sm-4">
    <div className="card mt-5 border-0">
      <div className="card-body">
      <i className="fa fa-television fa-5x text-primary" aria-hidden="true"></i>
