  ...
  <div className="col-sm-6">
    <div className="card mt-5">
      <div className="card-body">
        ...
        <h3><i className="fa fa-envelope-square  mt-4" aria-hidden="true"></i> E-mail :<br></br>info@SpeedSolution.com</h3>
       
        <h3> <i className="fa fa-map-marker mt-4" aria-hidden="true"></i>ADRESSE :<br></br>
113 rue de la République<br></br>
13002 Marseille<br></br>
</h3>

<h3><i className="fa fa-phone-square mt-4" aria-hidden="true"></i>Tel : <br></br>0 806 07 96 96</h3><br></br>
        </div>
        </div>
      </div>
    </div>
