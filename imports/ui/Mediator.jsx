  ...
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body bg-info" style={{padding:"70px",height:450}}>
        ...
        <p className="card-text">You wish to use our platform in order to carry out your own mediations. To do this, all you need to do is choose one of our packages and add your own files directly to our mediation management interface.</p>
