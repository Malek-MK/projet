        ...
        <div className="div">
            <div className="div fixed-top">
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light  ">
                    ...
                    <Link className="navbar-brand text-dark " to="/homeAdmin"><i className="fa fa-balance-scale"></i>Community</Link>
                    ...
                    <div className="collapse navbar-collapse ml-2" >
                        <ul className="navbar-nav ml-auto topnav">
                            ...
                            <li className="nav-item active">
                                <Link className="nav-link text-dark" to="/admin">My Account <span className="sr-only">(current)</span></Link>
                            </li>
